        ...
        <div v-show="!isLoading" class="container">
            <table class="table">
                ...
                <tr v-for="(event,index) in sonuc">
                    ...
                    <td>
                        <router-link class="detay" :to="'/TableDetail/'+event.id">detay</router-link>
                    </td>
    ...
    export default {
        ...
        methods: {
            getPosts() {
                this.isLoading = true;
                var self = this;
                axios.get('https://app.ticketmaster.com/discovery/v2/events.json?apikey=7elxdku9GGG5k8j0Xm8KWdANDgecHMV0&countryCode=US&classificationName=Sports&page=' + self.page)
